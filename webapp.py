"""
Web Application for Texas Auction Database

This module implements a web application for the Texas Auction Database,
providing a user interface to view and search auctions.
"""
